...
def controllersLibWindow():
    ...
    def lolliButtonPush(*args):
        ...
        functions.createLollipopCtrl(lollipopCtrlName=lolliName,radiusLolli=lolliRadius,numberOfVerticalCircles=verticalCircles,numberOfHorizontalCircles=horizontalCircles,stickLength=lolliStickLength)
    ...
    def rectangleButtonPush(*args):
        ...
        functions.createRectangleCtrl(rectangleCtrlName=rectCtrlName, rectangleWidth=rectCtrlWidth, rectangleHeight=rectCtrlHeight)
    ...
    def squareLolliButtonPush(*args):
        ...
        squareLolliStickLengthInput = cmds.floatField("sqLolliStickLengthFloatField", q=True, v=True)
        functions.createSquareLolliCtrl(squareLolliCtrlName=squareLolliNameInput, squareSide=squareLolliSide, stickLength=squareLolliStickLengthInput)
    ...
    def customTxtButtonPush(*args):
        ...
        functions.createCustomTextCtrl(customTextCtrlName=customTxtName, customTextInput=customTxtUsrInput, chooseFont=customTxtFont)
    ...
    cmds.separator()
    cmds.frameLayout( label='Circular Controllers', collapsable =True, labelAlign='top', borderStyle='in' )
    ...
    cmds.rowColumnLayout( numberOfColumns=2, columnAttach=(1, 'right', 0), columnWidth=[(1, 100), (2, 150)] )
    ...
    cmds.iconTextButton( style='iconAndTextHorizontal', image1='circleicon.png', label='Create Circle Controller', bgc = [0.5,0.5,0.5], command=circleButtonPush)
    ...
    cmds.rowColumnLayout( numberOfColumns=2, columnAttach=(1, 'right', 0), columnWidth=[(1, 150), (2, 150)] )
    cmds.text( label='Lollipop Name' )
    ...
    lolliStickLengthInput = cmds.floatField("lolliStickLengthFloatField", value=10, minValue=0.1)
    
    cmds.setParent('..') #back to column layout
    
    cmds.iconTextButton( style='iconAndTextHorizontal', image1='lolliicon.png', label='Create Lollipop Controller', bgc = [0.5,0.5,0.5], command=lolliButtonPush)
    ...
    cmds.separator()
    cmds.frameLayout( label='Rectangular Controllers', collapsable=True, labelAlign='top', borderStyle='in' )
    cmds.paneLayout( configuration='vertical2' )
    #left
    cmds.columnLayout(adjustableColumn=True)
    ...
    cmds.rowColumnLayout( numberOfColumns=2, columnAttach=(1, 'right', 0), columnWidth=[(1, 100), (2, 150)] )
    cmds.text( label='Rectangle Name' )
    ...
    cmds.iconTextButton( style='iconAndTextHorizontal', image1='sqricon.png', i="iconOnly", label='Create Rectangular Controller', bgc = [0.5,0.5,0.5], command=rectangleButtonPush)
    ...
    squareLolliNameTextField = cmds.textField("squareLolliNameField",tx="squareLolliCtrl_001")
    cmds.text(label='Square Side Length')
    cmds.floatField("sqLolliSideLengthFloatField", value=3, minValue=0.1)
    cmds.text(label='Stick Length')
    cmds.floatField("sqLolliStickLengthFloatField", value=10, minValue=0.1)
    cmds.setParent('..') #back to column layout
    cmds.iconTextButton( style='iconAndTextHorizontal', image1='sqrlolliicon.png', i="iconOnly", label='Create Square Lollipop Controller', bgc = [0.5,0.5,0.5], command=squareLolliButtonPush)
    ...
    #OTHER CONTROLLERS
    cmds.separator()
    cmds.frameLayout( label='Other Controllers', collapsable =True, labelAlign='top', borderStyle='in' )
    cmds.paneLayout( configuration='vertical2' )
    #left
    cmds.columnLayout(adjustableColumn=True)
    cmds.text(label='FK/IK Switch Controller')
    cmds.separator()
    cmds.iconTextButton( style='iconAndTextHorizontal', image1='fkikicon.png', label='Create FK/IK Switch Controller', bgc = [0.5,0.5,0.5], command=fkikButtonPush)
    ...
    cmds.iconTextButton( style='iconAndTextHorizontal', image1='customtxticon.png', label='Create Custom Text Controller', bgc = [0.5,0.5,0.5], command=customTxtButtonPush)
    ...
    cmds.columnLayout(adjustableColumn=True)
    cmds.separator()
    cmds.text( label='create an auto and offset group for the selected controllers, match pivots of their groups to the controller' )
    cmds.text( label='WARNING: Only run this after creation of all the controllers to avoid name clashes in the scene' )
